...
image_names = os.listdir('/home/yash/models/vggunet_he/results')
...
for images in tqdm(image_names):
    ...
    S = np.expand_dims(np.array(Image.open('/home/yash/models/vggunet_he/results/'+images).convert('L')),axis=-1)
    G = np.expand_dims(np.array(Image.open('/home/yash/models/vggunet_he/gt/'+images).resize((512,512)).convert('L')),axis=-1)
    #print S.shape
    #G.shape
...
f = open('Report_results_scratch_custom78ep.txt','w')
